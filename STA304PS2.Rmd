...
```{r,fig.cap='Figure 6',echo=FALSE,warning=FALSE}
...
# Appendix
 Code for this study, as well as our method of defining our probability values, can be found at: https://github.com/jordanregis/STA304PS2Survey/blob/main/Appendix.Rmd
